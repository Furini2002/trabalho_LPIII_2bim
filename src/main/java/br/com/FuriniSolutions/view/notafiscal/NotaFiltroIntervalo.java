...
import br.com.FuriniSolutions.view.notafiscal.*;
 ...
 * @author lucas
 */
public class NotaFiltroIntervalo extends javax.swing.JFrame implements Observer {
    ...
    private void buscarProdutos() {
        ...
        // cria o SwingWorker em segundo plano threds
        SwingWorker<List<NotaFiscal>, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(NotaFiltroIntervalo.this, "Erro ao buscar notas: " + e.getMessage());
                } finally {
    ...
    private void initComponents() {
        ...
        setTitle("Filtro de Itens da Nota por Intervalo");
        ...
        jLayeredPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jLayerCliente, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void buttonFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFiltrarActionPerformed
        ...
        try {
            ...
            notas = notaDao.buscarNotaFiscalPorIntervaloData(dataInicio, dataFim);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotaFiltroIntervalo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaFiltroIntervalo().setVisible(true);
            }
        });
    }
