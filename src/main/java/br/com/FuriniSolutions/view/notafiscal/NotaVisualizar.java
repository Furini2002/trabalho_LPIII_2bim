 ...
 * @author lucas
 */
public class NotaVisualizar extends javax.swing.JFrame {
    ...
    public NotaVisualizar(NotaFiscal nota) {
        initComponents();
    ...
    public void calcularTotal(NotaFiscal nota) {
        ...
        Double total = notaDAO.calcularValorTotalNota(nota);
    ...
    private void initComponents() {
        ...
        setTitle("Detalhes da Nota Fiscal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotaVisualizar.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaVisualizar().setVisible(true);
            }
        });
    }
