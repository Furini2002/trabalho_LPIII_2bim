...
import br.com.FuriniSolutions.view.produto.ProdutoCreate;
...
import br.com.FuriniSolutions.view.cliente.ClienteCreate;
 ...
 * @author lucas
 */
public class NotaCreate extends javax.swing.JFrame implements Subject {
    ...
    private void inicializarDados() {
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<>() {
            ...
            protected Void doInBackground() throws Exception {
                // Carrega os dados de clientes e produtos
                ClienteDAO clienteDAO = new ClienteDAO();
                clientes = clienteDAO.findAll(); // Carrega todos os clientes

                ProdutoDAO produtoDAO = new ProdutoDAO();
                produtos = produtoDAO.findAll(); // Carrega todos os produtos
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(NotaCreate.this, "Erro ao carregar dados: " + e.getMessage());
                } finally {
    ...
    private void buscarProdutos(String search) {
        ...
        for (Produto produto : produtos) {
            if (search.trim().isEmpty() || produto.getDescricao().toLowerCase().contains(search.toLowerCase())) {
                listModel.addElement(produto.getDescricao());
            }
        }

        // Atualiza o JList de produtos
    ...
    private void buscarClientes(String search) {
        ...
        for (Cliente cliente : clientes) {
            if (search.trim().isEmpty() || cliente.getNome().toLowerCase().contains(search.toLowerCase())) {
                listModel.addElement(cliente.getNome());
            }
        }

        // Atualiza o JList de clientes
    ...
    private void salvarNotaFiscal() {
        ...
        //estabelecendo relacionamento bidimensional
        List<ItemNota> listaItens = tablemodel.getlist();
        ...
        try {
            ...
            ExibirCupom frame = new ExibirCupom();
            frame.exibirCupomPopulado(nota);
    ...
    private void jbtnNovoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnNovoProdutoActionPerformed
        ProdutoCreate view = new ProdutoCreate();
    ...
    private void jbtnNovoClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnNovoClienteActionPerformed
        ClienteCreate view = new ClienteCreate();
        view.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotaCreate.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaCreate().setVisible(true);
            }
        });
    }
