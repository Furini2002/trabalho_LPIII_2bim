 ...
 * @author lucas
 */
public class NotaCreateUpdateView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotaCreateUpdateView.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaCreateUpdateView().setVisible(true);
            }
        });
    }
