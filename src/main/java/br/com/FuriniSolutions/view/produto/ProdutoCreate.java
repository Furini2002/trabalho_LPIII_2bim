 ...
 * @author lucas
 */
public class ProdutoCreate extends javax.swing.JFrame {
        ...
        SwingWorker<List<Produto>, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(ProdutoCreate.this, "Erro ao buscar produtos: " + e.getMessage());
                } finally {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoCreate.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProdutoCreate().setVisible(true);
            }
        });
    }
