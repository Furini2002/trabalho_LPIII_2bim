 ...
 */
package br.com.FuriniSolutions.view.cliente;
...
public class ClienteCreate extends javax.swing.JFrame {
    ...
    private void buscarClientes() {
        ...
        SwingWorker<List<Cliente>, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    List<Cliente> clientesRetornados = get();
                    tbm.addList(clientesRetornados);
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(ClienteCreate.this, "Erro ao buscar produtos: " + e.getMessage());
                } finally {
        ...
        if (clienteSelecionado == null) {
            ...
            if (confirmacao == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    try {
                        if (dao.delete(clienteSelecionado.getId())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteCreate.class
